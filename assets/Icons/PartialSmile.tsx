...
const PartialSmile = (props: SvgProps) => (
  <Svg
    width={36}
    height={36}
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
    <Path
      d="M24.524 20.925C23.2149 23.1069 20.5967 24.525 17.9786 24.525C15.3604 24.525 12.7422 23.1069 11.4331 20.925"
      stroke="black"
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
